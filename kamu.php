...
gar:
system("exit");
echo color("white","      _____     _           _  __  ______ \n");
echo color("white","     |  ___|_ _(_)___  __ _| | \ \/ /  _ \ \n");
echo color("white","     | |_ / _` | / __|/ _` | |  \  /| | | | \n");
echo color("white","     |  _| (_| | \__ \ (_| | |  /  \| |_| | \n");
echo color("white","     |_|  \__,_|_|___/\__,_|_| /_/\_\____/ \n");
echo color("blue","                Script Promo Gojek         \n");
echo color("white","  \n");
echo color("white","  \n");
echo color("white","╭───────────────── [ Welcome User ] ─────────────────╮ \n");
echo color("white","│                                                    │ \n");
echo color("white","│                         Hi!                        │ \n");
echo color("white","│     Terima Kasih Telah Menggunakan Script Ini.     │ \n");
echo color("white","│        Mohon Menggunakannya Sebaik Mungkin!        │ \n");
echo color("white","│                                                    │ \n");
echo color("white","│  Cara Penggunaan :                                 │ \n");
echo color("white","│                   Ketik Nomor Dengan Format        │ \n");
echo color("white","│                         628xxxxxxxxx               │ \n");
echo color("white","│  Cara Mendapatkan Voucher :                        │ \n");
echo color("white","│                   Silahkan Lihat Video Youtube     │ \n");
echo color("white","│                            Video Ini :             │ \n");
echo color("white","│                   https://youtu.be/Eh-nCQpYAyg     │ \n");
echo color("white","│                                                    │ \n");
echo color("white","│                     -Faisal XD                     │ \n");
echo color("white","│                                                    │ \n");
echo color("white","┌────────────────────────────────────────────────────╯ \n");
function change(){
        $nama = nama();
